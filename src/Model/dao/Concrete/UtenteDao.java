...
/**
 * Class which contains all queries to get user's informations from database
 */
public class UtenteDao implements UtenteDaoInterface {
    ...
    private static final String PLAY = "UPDATE utente SET puntiExp = ? + ? WHERE username = ?;";
     ...
     * @throws SQLException if no database connection is found or another error
     * occurs
     */
    @Override
     ...
     * @param utente user who votes
     * @param gioco voted game
     * @return boolean true if the user has already voted the game, false
     * otherwise
     * @throws SQLException if no database connection is found or another error
     * occurs
     */
     ...
     * @param utente user who reviews
     * @param gioco reviewed game
     * @return boolean true if the user has already reviewed the game, false
     * otherwise
     * @throws SQLException if no database connection is found or another error
     * occurs
     */
     ...
     * @return boolean true if email or username are already been used, false
     * otherwise
     * @throws SQLException if no database connection is found or another error
     * occurs
     */
